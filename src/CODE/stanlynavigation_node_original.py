...
class NavigationAndControlNode(Node):
    def __init__(self):
        ...
        self.speed_factor = 1.0  # Default to full speed
        self.create_subscription(Float32, '/obstacle_speed_factor', self.speed_factor_callback, 10)

        # Load lat/lon waypoints
        self.waypoints = self.load_waypoints('/home/user/abd_ws_2/src/tests/tests/perimeter/june19_1/final_combined_waypoints.csv')
    ...
    def speed_factor_callback(self, msg: Float32):
        self.speed_factor = max(0.0, min(1.0, msg.data))  # Clamp to [0, 1]
    ...
    def control_robot(self, steering_angle):
        ...
        speed = int(self.speed * self.speed_factor)  # ← this will keep decreasing speed
