...
class GPSDataPublisher(Node):
    ...
    def publish_gps_data(self):
        ...
        # if heading is None:
        #     self.get_logger().warn("Heading is None, setting to 0.0")
        #     heading = 0.0
        ...
        #     f"Publishing GPS Data: latitude={Latitude}, longitude={Longitude}, Heading= {heading}"
        # )
        ...
        # Append to CSV
        csv_path = '/home/user/abd_ws_2/src/tests/tests/gps/gps_data_log.csv'
        ...
        # self.get_logger().info("GPS data saved to CSV file.")
