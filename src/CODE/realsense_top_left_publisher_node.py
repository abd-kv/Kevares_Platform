...
class RealSensePublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_color = self.create_publisher(Image, 'top_left_color_image', 10)
        self.publisher_depth = self.create_publisher(Image, 'top_left_depth_image', 10)
        self.bridge = CvBridge()
        self.pipeline = rs.pipeline()
        self.config = rs.config()
        serial_number = '243522070518'  # Replace this with your left camera's serial number
