...
class PathGenerator(Node):
    def __init__(self):
        ...
        self.file_path = "/home/user/abd_ws_2/src/tests/tests/perimeter/24JUNABDE/gps_data.csv"
    ...
    def run(self):
        try:
            ...
            # border_paths[:,0] = border_paths[:,0]/math.cos(self.x_rad)
            # inner_boundary[:,0] = inner_boundary[:,0]/math.cos(self.x_rad)
            ...
            # primary[:,0] = primary[:,0]/math.cos(self.x_rad)
            # secondary[:,0] = secondary[:,0]/math.cos(self.x_rad)
            # tertiary[:,0] = tertiary[:,0]/math.cos(self.x_rad)
