...
class RearRightRealSensePublisher(Node):
    ...
    def __init__(self):
        super().__init__('rear_right_realsense_publisher_node')
        self.publisher_color = self.create_publisher(Image, 'rear_right_color_image', 10)
        self.publisher_depth = self.create_publisher(Image, 'rear_right_depth_image', 10)
        self.publisher_intrinsics = self.create_publisher(Int32MultiArray, 'rear_right_camera_info_array', 10)
        ...
        serial_number_right = '105422061537'
