...
class RearLeftRealSensePublisher(Node):
    ...
    def __init__(self):
        super().__init__('left_realsense_publisher_node')
        self.publisher_color = self.create_publisher(Image, 'left_color_image', 10)
        self.publisher_depth = self.create_publisher(Image, 'left_depth_image', 10)
        self.publisher_intrinsics = self.create_publisher(Int32MultiArray, 'left_camera_info_array', 10)
        ...
        serial_number_left = '215222077015'  # Replace this with your left camera's serial number
